...
<?php if ( $product->is_on_sale() ) : ?>
	...
	?>
	<?php echo apply_filters( 'woocommerce_sale_flash', '<div class="callout badge badge-'.$badge_style.'"><div class="badge-inner secondary on-sale"><span class="onsale">Sale!</span></div></div>', $post, $product ); ?>
